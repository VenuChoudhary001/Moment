  ...
  return (
    <>
      <section className=" my-24 md:my-48 flex flex-col gap-24 font-primary">
        <main className="container grid grid-cols-1 px-4 md:px-0 md:grid-cols-2 gap-10">
          <div className="max-w-[750px] text-4xl md:text-4xl lg:text-4xl text-black xl:text-6xl 2xl:text-7xl font-mediu ">
            Build a global brand even if you don’t have a website
          </div>
          <div className="text-black-100  xl:text-xl flex flex-col gap-6">
            <div className="">
      ...
      <section className="container  px-4 md:px-0 font-primary md:rounded-lg bg-secondary h-[250px] lg:h-[350px] items-center text-center justify-center flex flex-col gap-8 md:gap-12  text-white py-24 ">
        <div className="text-xl md:text-3xl lg:text-4xl xl:text-5xl font-bol">
